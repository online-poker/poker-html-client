...
declare class HammerInstance {
    ...
    // You shouldn't use this, this is an internally method use by the gestures. 
	// Only use it when you know what you're doing! You can read the sourcecode about how to use this.
