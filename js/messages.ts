...
let messages: any = {
    ...
    rounds: {
        preFlop: 'Первый раунд, делайте Ваши ставки',
        flop: 'Второй раунд, делайте Ваши ставки',
        tern: 'Третий раунд, делайте Ваши ставки',
        river: 'Четвертый раунд, делайте Ваши ставки',
    },
    broadcast: {
